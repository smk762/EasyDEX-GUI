          ...
          .then((sendPreflight) => {
            if (sendPreflight &&
              ...
              this.setState(Object.assign({}, this.state, {
                spvPreflightSendInProgress: false,
                spvDpowVerificationWarning: 'n/a',
                noUtxo: sendPreflight.result === 'no valid utxo' || typeof sendPreflight.result === 'string' && (sendPreflight.result.indexOf('Spend value is too large') > -1 || sendPreflight.result.indexOf('Unable to find best fit UTXO') > -1) ? true : false,
