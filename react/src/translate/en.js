...
const LANG_EN = {
  ...
  API: {
    ...
    'shepherdElectrumCoins': 'Unable to get coins data',
    'shepherdElectrumAuth': 'Unable to get auth data',
    'shepherdElectrumAddCoin': 'Unable to add a coin',
    'shepherdHerd': 'Unable to add a coin',
    '_shepherdGetConfig': 'Unable to get daemon config',
    'shepherdGetConfig': 'Unable to get daemon config',
    'modifyAddressBook': 'Unable to save address book data',
    'getAddressBook': 'Unable to get address book data',
    'shepherdCli': 'Unable to get CLI data',
    'shepherdElectrumLock': 'Unable to flush SPV auth data',
    'shepherdElectrumLogout': 'Unable to end SPV session',
    'shepherdElectionsLogout': 'Unable to end elections session',
    'shepherdStopCoind': 'Unable to stop daemon',
    'shepherdRemoveCoin': 'Unable to remove coin',
    'shepherdGetCoinList': 'Unable to get coins list',
    'shepherdPostCoinList': 'Unable to update coins list',
    'shepherdClearCoindFolder': 'Unable to clear daemon data folder',
    'shepherdElectrumTransactionsCSV': 'Unable to get transactions history data',
    'shepherdElectionsTransactions': 'Unable to get transactions history data',
    'shepherdElectrumTransactions': 'Unable to get transactions history data',
    'shepherdElectrumTransactionsKV': 'Unable to get transactions history data',
    'shepherdElectionsBalance': 'Unable to get balance data',
    'shepherdElectrumBalance': 'Unable to get balance data',
    'shepherdElectionsStatus': 'Unable to get elections status data',
    'shepherdElectionsLogin': 'Unable to get elections auth data',
    'shepherdElectionsSend': 'Unable to update elections data',
    'shepherdElectionsSendMany': 'Unable to update elections data',
    'shepherdGetLocalBTCFees': 'Unable to get BTC fees data',
    'shepherdElectrumSetServer': 'Unable to update SPV server data',
    'shepherdElectrumCheckServerConnection': 'Unable to update SPV server data',
    'shepherdElectrumKeys': 'Unable to get SPV auth data',
    'shepherdElectrumSend': 'Unable to push transaction data',
    'shepherdElectrumListunspent': 'Unable to get transaction data',
    'shepherdElectrumBip39Keys': 'Unable to fetch data',
    'shepherdElectrumKvServersList': 'Unable to get KV data',
